...
namespace Projeto2025_API.Controllers
{
    ...
    public class ProdutoController : ControllerBase
    {
        ...
        private IValidator<ProdutoDto> validacao;

        public ProdutoController(IProdutoService service, IValidator<ProdutoDto> validacao)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<ProdutoDto>> save(ProdutoDto dto) {
        ...
        [HttpPut]
        public async Task<ActionResult> update(ProdutoDto dto) {
            var result = validacao.Validate(dto);
            if (result.IsValid)
            {
        ...
        [HttpGet("{nome}")]
        public async Task<ActionResult<List<ProdutoDto>>> lista(string nome) {
